...
#define SWITCH_PIN0 PINC0
#define SWITCH_PIN1 PINC1
#define SWITCH_PIN2 PINC2
#define SWITCH_PIN3 PINC3
#define SWITCH_PIN4 PINC4
#define SWITCH_PIN5 PINC5
...
#define tetris_get_key		mikroswitch_get_key
