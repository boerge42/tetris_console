...
// *******************************************************
wii_nunchuck_controls_t wii_nunchuck_get_data(void)
{
	uint8_t buf[WII_CONTROLLER_DATA_LEN]; 
	wii_nunchuck_controls_t ctrl;
...
// *******************************************************
wii_classic_controls_t  wii_classic_get_data(void)
{
	uint8_t buf[WII_CONTROLLER_DATA_LEN]; 
	wii_classic_controls_t ctrl;
